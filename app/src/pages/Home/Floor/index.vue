      ...
      <div class="tab-content">
        <div class="tab-pane">
          <div class="floor-1">
            ...
            <div class="floorBanner" v-if="list">
              <!-- 轮播图 -->
...
export default {
  ...
  mounted() {
    ...
    // 第一次书写轮播图的时候，是当前组件内部发请求、动态渲染解构【前台至少服务器数据需要回来】，因此当年的写法在这里不行
    // 现在的这种写法为什么可以：因为请求是父组件发的，父组件的数据已经拿到，才会传递props给子组件，而且结果已经都有了的情况下执行mounted
